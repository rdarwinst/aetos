<div class="mb-3">
    ...
    <div class="invalid-feedback"><?php echo s($errores['name']) ?? 'Please enter a service name.'; ?></div>
...
<div class="mb-3">
    ...
    <textarea
        ...
        class="form-control rounded-0 <?php echo isset($errores['description']) ? 'is-invalid' : ''; ?>"><?php echo s($services->description); ?></textarea>
    <div class="invalid-feedback"><?php echo s($errores['description']) ?? 'Please enter a description or features of the service.'; ?></div>
...
<div class="mb-3">
    ...
    <div class="invalid-feedback"><?php echo s($errores['image']) ?? 'Please upload an image of the service.'; ?></div>
