                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <img src="/build/img/zeus.svg" alt="Aetos Icon" class="img-fluid">
                            </div>
                            <div class="col-md-6">
                                <div class="icon-info">
                                    <h2 class="text-center text-md-start">Ray <span>Authority</span></h2>
                    ...
                    <div class="swiper-slide">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <img src="/build/img/poseidon.svg" alt="Aetos Icon" class="img-fluid">
                            </div>
                            <div class="col-md-6">
                                <div class="icon-info">
                                    <h2 class="text-center text-md-start">Trident <span>Balance</span></h2>
                                    <p class="text-center text-md-start">&nbsp;</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <img src="/build/img/2.svg" alt="Aetos Icon" class="img-fluid">
                            </div>
                            <div class="col-md-6">
                                <div class="icon-info">
                                    <h2 class="text-center text-md-start">Helmet <span>Warrior</span></h2>
                                    <p class="text-center text-md-start">&nbsp;</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <img src="/build/img/5.svg" alt="Aetos Icon" class="img-fluid">
                            </div>
                            <div class="col-md-6">
                                <div class="icon-info">
                                    <h2 class="text-center text-md-start">Bident <span>Wealth</span></h2>
                                    <p class="text-center text-md-start">&nbsp;</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <img src="/build/img/martillo.svg" alt="Aetos Icon" class="img-fluid">
                            </div>
                            <div class="col-md-6">
                                <div class="icon-info">
                                    <h2 class="text-center text-md-start">Axe & Hammer <span>Create</span></h2>
                                    <p class="text-center text-md-start">&nbsp;</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <img src="/build/img/3.svg" alt="Aetos Icon" class="img-fluid">
                            </div>
                            <div class="col-md-6">
                                <div class="icon-info">
                                    <h2 class="text-center text-md-start">Shield <span>Protection</span></h2>
                                    <p class="text-center text-md-start">&nbsp;</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <img src="/build/img/4.svg" alt="Aetos Icon" class="img-fluid">
                            </div>
                            <div class="col-md-6">
                                <div class="icon-info">
                                    <h2 class="text-center text-md-start">Sword <span>Energy</span></h2>
                                    <p class="text-center text-md-start">&nbsp;</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container-xl min-vh-100">
            <div class="row justify-content-around align-items-center min-vh-100">
                ...
                <div class="col-md-4 subElement complementary">
                    <p>We are a strategic branding agency with the knowledge to build & reposition powerful brands. We advise startups & expanding SMEs to communicate their brands, connecting with their target audiences to transform their brands into an emotional experience.</p>
                    <p>Based on strategic thinking, we build unique, lasting, and memorable brands, adapting ourselves to each client; being each project unique that connects and generates new emotions.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row mx-5 justify-content-center align-items-center gap-3 my-4 order-1 order-md-2 subElement">
                <div class="col-md-3 service">
                    <picture>
                        ...
                        <img loading="lazy" width="200" height="300" src="/build/img/identity-3.jpg" alt="Imagen Identity" class="img-fluid">
                    </picture>
                    <div class="service__info">
                        <h3 class="service__title">Strategy</h3>
                        <ul class="text-start">
                            <li>Brand Essense</li>
                            <li>Brand Concept</li>
                            <li>Brand Architecture</li>
                            <li>Brand Voice: Tone, Naming, Slogan, Tag Line</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-3 service">
                    <picture>
                        ...
                        <img loading="lazy" width="200" height="300" src="/build/img/identity-2.jpg" alt="Imagen Identity" class="img-fluid">
                    </picture>
                    <div class="service__info">
                        <h3 class="service__title">Branding</h3>
                        <ul class="text-start">
                            <li>Brand Identity: Logo, Symbol, Typography, Color Palette</li>
                            <li>Visual Language: Aesthetics, Visual Presentation</li>
                            <li>Identity Visual Systems: Imagery, Layout, Iconography, Patterns / Textures</li>
                ...
                <div class="col-md-3 service">
                    <picture>
                        ...
                        <img loading="lazy" width="200" height="300" src="/build/img/identity-1.jpg" alt="Imagen Identity" class="img-fluid">
                    </picture>
                    <div class="service__info">
                        <h3 class="service__title">Digital Branding</h3>
                        <ul class="text-start">
                            <li>UX / UI</li>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 p-0 mb-5">
                            ...
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <p class="fs-6">Monday - Friday: 9 am to 6 pm</p>
                                </li>
                                <li class="nav-item">
                                    <a href="mailto:info@aetos.life" class="link-dark text-decoration-none fs-6">info@aetos.life</a>
                                </li>
                            </ul>
                        </div>
